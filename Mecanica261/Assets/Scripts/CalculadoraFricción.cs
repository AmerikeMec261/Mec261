...
public class CalculadoraFricción : MonoBehaviour
{
   [Header("Dependencies")]
    ...
    {
        _answerLabel.text = (CalculateParalelWeight() + CalculateFrictionForce()).ToString("F2") + " N";
    ...
    private float CalculateParalelWeight()
    {
