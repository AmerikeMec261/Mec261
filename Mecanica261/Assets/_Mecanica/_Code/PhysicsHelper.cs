...
public static class PhysicsHelper
{
    ...
    // Se aplica una fuerza para llegar a la velocidad indicada mientras se compensa con aceleracion vectorial
    ...
    public static void ApplyForceToReachVelocity(Rigidbody rigidbody, Vector3 velocity, float force = 1, ForceMode mode = ForceMode.Force)
    {
        ...
        // Se compensa la resistencia del drag normalizandola y multiplicando por el damping linear
        velocity = velocity + velocity.normalized * 0.2f * rigidbody.linearDamping;

        //force = 1 => necesita 1 para llegar a la velocidad (Si la masa es 1 1) => force puede ser maximo 1 / Time.fixedDeltaTime (referencia a la guia)
        force = Mathf.Clamp(force, -rigidbody.mass / Time.fixedDeltaTime, rigidbody.mass / Time.fixedDeltaTime);

        // El producto escalar es una proyección del lado derecho al lado izquierdo con una longitud igual a resultado / magnitud del lado izquierdo https://www.youtube.com/watch?v=h0NJK4mEIJU
        // Se aplican fuerzas dependiendo la proyeccion del objetivo
    ...
    // Control de rotacion en X usando RPS
    ...
    // La conversion de rotacion a velocidad angular
    ...
    // Calculo normal y centro del plano sobre su superficie
    ...
    //https://youtu.be/yEGdYM0nk1I?si=sBrR5CXw02C8gDeO
}
