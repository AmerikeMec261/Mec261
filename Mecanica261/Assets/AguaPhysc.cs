...
public class AguaPhysc : MonoBehaviour
{
    [Header("Water")]
    ...
    [Header("BattleShip")]
    [SerializeField] private float _shapeFactor_ = 1.0f;
    ...
    private void CalculateHullData()
    {
        ...
        _HullVolume = _area * _HullHeight * _shapeFactor_;

        float requireVolume = _rigidbody.mass / _waterDensity;
        _waterDraft = requireVolume / (_area * _shapeFactor_);
